...
Current phase: **Phase 2 complete (Sprint Eval-RAG-Core closed 2026-06-07) — clean baseline established at `evaluation/results/baseline-2026-06-07/`.** Next major milestone: **Phase 3 — Graph layer (Neo4j entity graph).** Note: the 4 questions that fail retrieval entirely (q006/q012/q014/q017) are addressed by Phase 4 hybrid retrieval, not Phase 3.
