...
Current phase: **Phase 1 complete; Phase 1.7 Sprint Rate-Limit complete — ready for Phase 1.7.5.** Next major milestone: **Phase 2 — Evaluation (Ragas-style metrics + golden dataset).**
