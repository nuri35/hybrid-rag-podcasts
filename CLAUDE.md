...
| 4. Hybrid retrieval | 🟡 In progress — 4.6 closure remaining (started 2026-06-10) | **Redefined: vector + Elasticsearch keyword fusion via RRF + ±1 neighbor expansion** (was "vector + graph"). 4.1–4.5 DONE incl. final clean eval (2026-06-14): **Hit@5 0.810→0.905, MRR 0.712→0.774, Context Recall 0.767→0.900, substantive Faithfulness 0.905; q014/q017 fixed, q006/q012 documented misses, 0 regressions.** Two post-eval fixes landed (citation regex `601c32d`, eval methodology `bc8135b`). **Remaining: 4.6 docs/ADR/README closure.** See the Phase 4 section below + `docs/phases/phase-4.md`. |
